...
namespace Hermes.Server.Speaker
{
 public class NewIncidentPage
 {
  ...
  public static async Task page(string IncidentID)
  {
   if (Configuration.useAutoDispatcher == false) return;
   Speaker.speak((await DBInterface.getPagingIncident(IncidentID)).ToString());
  }
